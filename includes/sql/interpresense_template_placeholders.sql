...
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionNameEn','The name of the institution using this application (in English)','',1,1);
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionNameFr','The name of the institution using this application (en Francais)','',1,1);
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionAddressEn','The address of the institution using this application (in English)','',1,1);
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionAddressFr','The address of the institution using this application (en Francais)','',1,1);
...
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionDeptNameEn','The name of the department within the institution using this application (in English)','',1,1);
INSERT INTO `interpresense_template_placeholders` (`placeholder`, `description_en`, `description_fr`, `for_emails`, `for_reports`) VALUES ('#institutionDeptNameFr','The name of the department within the institution using this application (en Francais)','',1,1);
