...
CREATE TABLE `interpresense_service_provider_invoice_files` (
  ...
  CONSTRAINT `link_to_invoices` FOREIGN KEY (`invoice_id`) REFERENCES `interpresense_service_provider_invoices` (`invoice_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
