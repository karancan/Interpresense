...
-- @todo: add sensible content for emails 4, 5 and 6
...
INSERT INTO `interpresense_email_templates` (`email_id`, `name`, `content`, `description`, `subject`) VALUES (3, 'Account password reset', '<div><span style="font-style: italic;">This is an automated message. Please do not reply to this email.</span></div><div><span style="font-style: italic;"><br></span></div><p>Dear #adminUserFirstName,</p><div>You have requested a password reset for your administrative account. If you did not make this request, please ignore this email.</div><div><br></div><div>Confirm this password reset request by clicking here: </div><p>#passwordResetLink</p><div><br></div><div>Thank you,</div><div><br></div><p>#institutionDeptNameEn<br>#institutionPhone<br>#institutionEmail</p>', 'This email is sent out when an user requests a password reset', 'Interpresense - Password reset');
