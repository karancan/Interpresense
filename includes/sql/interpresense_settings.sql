...
INSERT INTO `interpresense_settings` (`setting_key`, `setting_value`, `description_en`, `description_fr`, `internal_use`,`inserted_on`, `updated_on`) VALUES ('invoicing_post_update_message_en','The invoice has been updated.','The message displayed after an invoice is updated.','','0',NOW(),NOW());
INSERT INTO `interpresense_settings` (`setting_key`, `setting_value`, `description_en`, `description_fr`, `internal_use`,`inserted_on`, `updated_on`) VALUES ('invoicing_post_update_message_fr','La facture a été mis à jour.','The message displayed after an invoice is updated.','','0',NOW(),NOW());
