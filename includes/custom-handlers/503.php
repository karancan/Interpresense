                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <div class="jumbotron-photo error-code-container">
                            <h1 class="error-code text-center"><i class="fa fa-thumbs-o-down"></i> 503</h1>
                        </div>
                        <div class="jumbotron-contents">
                            <h1 class="error-description">This application is temporarily unavailable. Please check back shortly…</h1>
