...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <a href="invoicesSubmitted.php?page=export&start=<?= $filter_start_date ?>&end=<?= $filter_end_date ?>" class="btn btn-info btn-block admin-add-button"><i class="fa fa-table"></i> Export (CSV format)</a>
        </div>
    </div>
